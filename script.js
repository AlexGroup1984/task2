...
function paralellepiped() {
    ...
    b = document.getElementById("parallelepiped_b").value;
    angle = document.getElementById("parallelepiped_angle").value;

    parallelepiped.style.height = (a * 37.936267) / 10 + "px";
    parallelepiped.style.width = (b * 37.936267) / 10 + "px";
